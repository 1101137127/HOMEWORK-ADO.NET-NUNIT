...
namespace WebApplication1
{
    ...
    public partial class WebForm5 : System.Web.UI.Page
    {
        ...
        {
            using (SqlConnection cn = new SqlConnection(ConfigurationManager.ConnectionStrings["20150327ConnectionString"].ConnectionString))
            {
                using (SqlCommand cmd = cn.CreateCommand())
                {
                    cmd.CommandText = "select * from dbo.Students where Name like @name";
